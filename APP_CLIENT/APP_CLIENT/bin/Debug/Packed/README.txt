This folder contains the signed Packed Release assemblies, 
their dependencies and XML documentation.

These assemblies are linked to the packed Awesomium libraries.
